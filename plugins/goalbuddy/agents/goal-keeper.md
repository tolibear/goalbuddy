...
```json
{
  "goalbuddy_keeper_request_v1": {
    ...
    "operation": "inspect | apply_receipt | apply_amendment | apply_hydration | enter_exact_human_wait | resume_exact_human_reply | complete_goal | activate | update_control | repair",
